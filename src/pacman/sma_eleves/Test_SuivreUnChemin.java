...
/**
 * Cette classe permet le test de l'implementation de Agent_FollowPath
 * 
 * @author denoyer
 * 
 */
public class Test_SuivreUnChemin {
	public static void main(String args[]) throws ParseException,
			...
			IllegalAccessException, MazeException {
		...
		ArrayList<Path> all_paths = SetPaths.calculTousLesCheminsLargeur(sx,
				sy, dx, dy, maze, 50);
