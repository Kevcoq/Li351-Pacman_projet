...
public class AgentAction {
	...
	/**
	 * Construit une action � partir d'une direction: Maze.NORTH=0,
	 * Maze.SOUTH=1, Maze.EAST=2, Maze.WEST=3, Maze.STOP=4
	 * 
	 * @param direction
	 *            la direction
	 */
	...
	/**
	 * Permet de connaitre le d�placement correspondant en X
	 * 
	 * @return
	 */
	public int getX() {
	...
	/**
	 * Permet de connaitre le d�placement correspondant en Y
	 * 
	 * @return
	 */
	public int getY() {
	...
	public String toString() {
		return "AgentAction [vx=" + vx + ", vy=" + vy + ", direction="
				+ direction + "]";
	}
